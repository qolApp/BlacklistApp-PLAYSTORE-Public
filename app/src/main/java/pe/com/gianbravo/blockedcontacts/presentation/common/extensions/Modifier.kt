package pe.com.gianbravo.blockedcontacts.presentation.common.extensions
...
fun Modifier.addDebugBorder(color: Color): Modifier = composed {
	debugBorder(color = color)?.let {
		return@composed border(it)
	}
	this
}
